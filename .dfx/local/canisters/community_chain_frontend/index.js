...
import { idlFactory } from './community_chain_frontend.did.js';
export { idlFactory } from './community_chain_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMMUNITY_CHAIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./community_chain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the community_chain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./community_chain_frontend.did.js")._SERVICE>}
 */
export const community_chain_frontend = createActor(canisterId);
